...
export const ControlKind = Object.freeze({
  ...
  presentationRouteMonitoringGain: 13,
  presentationRouteWetMix: 14,
  presentationMasterMonitoringGain: 15,
  presentationJitterScale: 16,
  presentationDerivativeMix: 17,
  presentationAirNoiseMix: 18,
  presentationRouteTransferGain: 19,
  presentationJitterCutoff: 20,
  presentationAirNoiseCutoff: 21,
  presentationCylinderGain: 22,
  simulationThrottleGamma: 23,
  simulationCombustionCycleVariation: 24,
  simulationRotatingInertiaScale: 25,
});
